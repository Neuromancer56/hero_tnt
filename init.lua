...
minetest.register_node("hero_tnt:boom", {
	drawtype = "airlike",
...
minetest.register_node("hero_tnt:gunpowder", {
...
minetest.register_node("hero_tnt:gunpowder_burning", {
	drawtype = "raillike",
	paramtype = "light",
	sunlight_propagates = true,
	walkable = false,
...
minetest.register_craftitem("hero_tnt:tnt_stick", {
...
function tnt.register_tnt(def)
	...
	local tnt_top = def.tiles.top or def.name .. "_top.png^[colorize:blue:40"
	local tnt_bottom = def.tiles.bottom or def.name .. "_bottom.png^[colorize:blue:40" --^[colorize:sienna:40^[colorize:blue:40
	local tnt_side = def.tiles.side or def.name .. "_side.png^[colorize:blue:40"
	local tnt_burning = def.tiles.burning or def.name .. "_top_burning_animated.png^[colorize:blue:40"
